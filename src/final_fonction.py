...
def write_whole_svg(
    ...
    svg_list = write_svg.replace_nodes_color_2(svg_list, node_to_color)
    ...
    always_present_eplet, not_always_present_eplet, always_present_eplet_dict, not_always_present_eplet_dict = eplet_extraction.get_bead_and_eplet_to_write(positive_bead,negative_bead, df_eplet_file)

    #Create dictionnary with eplets to write on link, and eplets to write on beads.
    stronger_eplet_on_link, strong_eplet_on_link, stronger_eplet_on_bead, strong_eplet_on_bead = eplet_extraction.where_to_write_eplets(link_between_pos,always_present_eplet, not_always_present_eplet, always_present_eplet_dict, not_always_present_eplet_dict, positive_bead)
    ...
    svg_list = write_eplet.write_stronger_eplet_on_bead(svg_list,bead_position,stronger_eplet_on_bead)

    #Write strong eplet on bead
    svg_list = write_eplet.write_strong_eplet_on_bead(svg_list, bead_position, strong_eplet_on_bead)
