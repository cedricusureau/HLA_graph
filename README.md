...
Another way to understand the format of input file, is to download examples directly from the websites. Once acquired, you can modify these files by overwriting the MFI values of a new sample.
<p align="center">
